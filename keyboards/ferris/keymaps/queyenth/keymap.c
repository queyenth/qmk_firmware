...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_CANARY] = LAYOUT(
    ...
    KC_Q, KC_J, KC_V, KC_D,   KC_K,     KC_X,    KC_H, KC_UNDS, KC_COMM, KC_DOT,
                      LA_NAV, KC_SPC,   OS_SFT,  LA_SYM
                     ),
  [_QWERTY] = LAYOUT(
  ...
  [_NAV] = LAYOUT(
    ...
    KC_PSCR, KC_MUTE, S(KC_INS), NW_TOGG, SW_LANG,   KC_HOME, KC_PGDN, KC_PGUP, KC_END,  CW_TOGG,
                                 _______, _______,   _______, _______
                     ),
  [_SYM] = LAYOUT(
    KC_BSLS, KC_LBRC, KC_LCBR, KC_LPRN, KC_TILD,   KC_CIRC, KC_RPRN, KC_RCBR, KC_RBRC, KC_COLN,
    KC_EXLM, KC_PLUS, KC_MINS, KC_UNDS, KC_EQL,    KC_SCLN, OS_CTL,  OS_SFT,  OS_ALT,  OS_GUI,
    KC_GRV,  KC_ASTR, KC_AT,   KC_DLR,  KC_PERC,   KC_LT,   KC_GT,   KC_AMPR, KC_HASH, KC_PIPE,
                               _______, _______,   _______, _______
                     ),
  [_FN] = LAYOUT(
