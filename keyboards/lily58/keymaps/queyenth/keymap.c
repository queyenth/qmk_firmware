...
const uint16_t PROGMEM caps_word_combo[] = {KC_S, KC_E, COMBO_END};
combo_t key_combos[] = {
 ...
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      | play | back |  fwd | volup| voldn|                    |  C-  | caps |insert| del  | bspc |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |  GUI |  ALT |  SFT |  CTL |  Tab |-------.    ,-------| Left | Down |  Up  | Right| enter|
 * |------+------+------+------+------+------|       |    |       |------+------+------+------+------+------|
 * |      | prsc | copy | paste|  cut | mute |-------|    |-------| Home | PgDn | PgUp | End  | word |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   |      |      |      | /       /       \      \  |      |      |      |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
...
[_NAV] = LAYOUT(
  ...
  _______, KC_MPLY, KC_MPRV, KC_MNXT, KC_VOLD, KC_VOLU,                   SP_CTL,  KC_CAPS, KC_INS,  KC_DEL,  KC_BSPC, _______,
  _______, OS_GUI,  OS_ALT,  OS_SFT,  OS_CTL,  KC_TAB,                    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_ENT,  _______,
  _______, KC_PSCR, KC_COPY, KC_PSTE, KC_CUT,  KC_MUTE, _______, _______, KC_HOME, KC_PGDN, KC_PGDN, KC_END,  CW_TOGG, _______,
...
[_SYM] = LAYOUT(
  ...
  _______, KC_MINS, KC_ASTR, KC_EQL,  KC_UNDS, KC_SCLN,                   KC_COLN, OS_CTL,  OS_SFT,  OS_ALT,  OS_GUI,  _______,
  _______, KC_PLUS, KC_PIPE, KC_AT,   KC_DLR,  KC_PERC, _______, _______, _______, KC_BSLS, KC_AMPR, KC_HASH, KC_EXLM, _______,
                             _______, _______, _______, _______, _______, _______, _______, _______
),
/* NUM
 * ,-----------------------------------------.                    ,-----------------------------------------.
